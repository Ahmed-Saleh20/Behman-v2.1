		        ...
		        <div class="l-part">
		         <form  action="docsignup.php" method="post">
		            ...
		            <div class="input-group">
                     ...
                     <div class="input-group">
					    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
					    <input type="tel" class="form-control" placeholder="Phone number" name="pnum" required="required">
					</div><br>
                     <div class="input-group">
					    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
					    <input type="text" class="form-control" placeholder="Your Address" name="addrs" required="required">
					</div><br>
					<div class="input-group">
...
<?php
	if(isset($_POST['sign_up'])){
		...
		$stmt = $con->prepare("INSERT into 
									users 
				(f_name,l_name,user_name,describe_user,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,status,posts,recovery_account,type,phone,address,approved)
									values 
                                    ('$first_name','$last_name','$username','Hello!! This is my default status','........','$pass','$email','$country','$gender','$birthday','default.png','default_cover.jpg',NOW(),'$status','$posts','ifyouaregootatsomethingdontdoitforfree45566677888','1','$phone','$address','0')");
		$stmt ->execute();
