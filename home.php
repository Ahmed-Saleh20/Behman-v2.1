...
?>
<div class="row">
	<div class="col-sm-2" style="text-align: center; background-color: red">SlideBar</div>
<div class="container" style="background-color: green">
	<div class="col-sm-8"style="text-align: center; background-color: blue;">Body</div>

	<div class="col-sm-2" style="text-align: center; background-color: red ;">Best</div>
</div>
</div>
...
<?php
	...
	$select_posts = $con->prepare("SELECT * FROM posts WHERE postType = 1  ORDER BY post_id Desc ");
